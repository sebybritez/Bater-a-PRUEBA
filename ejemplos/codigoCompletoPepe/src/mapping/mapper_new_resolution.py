...
class Mapper:
    ...
    def add_tile(self, tile):
        ...
        elif self.tiles[tile.pos].tile_type == TileType.UNKNOWN and tile.tile_type != TileType.UNKNOWN:
            self.tiles[tile.pos].tile_type = tile.tile_type
    ...
    def mapping_pixels(self, robot_start_pos):
        ...
        for tile_col in range(min_col, max_col + 1):
            ...
            for tile_row in range(min_row, max_row + 1):
                ...
                tile_type = self.tiles[tile_pos].tile_type
                tile_area = self.tiles[tile_pos].area
                if tile_type == TileType.STANDARD or tile_type == TileType.UNKNOWN or tile_type == TileType.CONTACT:
                    matrix_row += 4
                    continue
                else:
